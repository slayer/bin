...
sudo apt-get install -y autoconf build-essential libxml2-dev libxslt-dev libmysqlclient-dev libcurl4-openssl-dev libreadline-dev libreadline6-dev libncurses-dev
